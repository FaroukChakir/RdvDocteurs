...
import { Router, Route, Link,BrowserRouter, Switch,withRouter,useHistory } from 'react-router-dom'
...
export default class DropDownSeance extends Component
{
    ...
    for(var i =0 ; i<this.state.RDV.length;i++)
    {
        if(this.state.RDV[i].day==Id)
        {
            ...
            if(this.state.RDV[i].seance1==="false")
            {
                ...
                items.push(<input id="RDB" type="radio" onClick={() => this.handleInput("seance1")} name="drone" value="seance2"  />)
            ...
            {
                // items.push(<ul>14h-15h</ul><input type="radio" value={this.state.days[i].seance5} key={this.state.days[i].day}/>)
                items.push(<input id="RDB" type="radio" onClick={() => this.handleInput("seance2")}  name="drone" value="seance2"  />)
            ...
            {
                // items.push(<ul>14h-15h</ul><input type="radio" value={this.state.days[i].seance5} key={this.state.days[i].day}/>)
                items.push(<input id="RDB" type="radio" onClick={() => this.handleInput("seance3")} name="drone" value={this.state.RDV[i].seance3}  />)
            ...
            {
                // items.push(<ul>14h-15h</ul><input type="radio" value={this.state.days[i].seance5} key={this.state.days[i].day}/>)
                items.push(<input id="RDB" type="radio" onClick={() => this.handleInput("seance4")}  name="drone" value={this.state.RDV[i].seance4}  />)
            ...
            {
                // items.push(<ul>14h-15h</ul><input type="radio" value={this.state.days[i].seance5} key={this.state.days[i].day}/>)
                items.push(<input id="RDB" type="radio" onClick={() => this.handleInput("seance5")} name="drone" value={this.state.RDV[i].seance5}  />)
  ...
  <div className="Head">
    ...
    <div id="ContainerForRdb" >
        <ul style={{color:'Red',fontWeight:'bold'}} >Merci de choisir la Séance</ul>
        
        {items}
    </div>
    <div>
    
    <Link  onClick={this.test} > <input type="submit" onClick={() => this.ReservingFunc()}/></Link> 
    </div>
    </div>
  </div>
